...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogRakesh";
    static String forumTableName = "ForumRakesh";
    static String threadTableName = "ThreadRakesh";
    static String replyTableName = "ReplyRakesh";
